...
## Facts
- Server: n1.serezhkin.com (`ssh n1`), deploy dir `~vany/aancha`, app on 127.0.0.1:8087 behind existing nginx + Let's Encrypt at https://aancha.serezhkin.com. Box: 1 vCPU / 457 MB / disk tight — never compile there, memory-cap the container.
